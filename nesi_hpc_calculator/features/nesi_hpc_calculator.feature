Feature: NeSI HPC Calculator
  ...
  Scenario: Test error handling for Shared mode
    ...
    Examples:
      | platform | job_size | wall_clock_hours | job_runs | cpu_core_hours | hpc_cost | project_cost | nesi_contribution | message                         |
  ...
  Scenario: Test error handling for Scaled mode
    ...
    Examples:
      | platform | job_size | cpu_cores_per_node | wall_clock_hours | job_runs | cpu_core_hours | hpc_cost | project_cost | nesi_contribution | message                                             |
